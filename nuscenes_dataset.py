...
class NuScenesDataset(Dataset): # It's good practice to inherit from Dataset
    # 在参数列表中添加 seq_len
    def __init__(self, version='v1.0-mini', dataroot="/home/huangjinrong/d_pmbm_net/data/sets", verbose=True, seq_len=10, split='train'):
